...
Currently, only the latest major release of NewsApp is actively supported with security updates. 
...
- **Resolution:** If the vulnerability is verified, we will work promptly to issue a patched release and credit you (if desired). If the report is declined, we will provide a clear explanation of our reasoning.